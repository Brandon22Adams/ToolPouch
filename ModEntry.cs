...
namespace ToolPouch
{
    public class ModEntry : Mod
    {
        ...
        {
            if (!canOpenMenu(e.Button)) return;
        ...
        private void onLaunched(object sender, GameLaunchedEventArgs e)
        {
            ...
            api.RegisterSimpleOption(ModManifest, "Consider the Horse Flute as a Tool", "The Game does not consider the Horse Flute a Tool but you may have acces to it via ToolPouch anyway", () => Config.ConsiderHorseFlutAsTool, (bool val) => Config.ConsiderHorseFlutAsTool = val);
